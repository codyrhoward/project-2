...
class Show extends React.Component {
    render() {
        // const name = this.props.scifi.name;
        // const image = this.props.scifi.image;
        // const watched = this.props.scifi.watched;
        // destructuring
        const { title, image, _id, synopsis, watched, trailer } = this.props.scifi;
        return (
            <Default>
            <body className="scifi-show">
        <div className="container my-container">
            <div className="row align-items-end mt-4">
                ...
                <div className="col">
                    ...
                    <a className="btn btn-primary my-3 d-flex justify-content-end text-align-center"href={`/scifis/${_id}/edit`}>Edit</a> 
