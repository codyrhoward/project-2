...
class Edit extends React.Component {
    render() {
        const { _id, title, image, watched, trailer, synopsis} = this.props.scifi;
        return (
            <Default>
            <br/>
            <h1 className="new-h1 d-flex justify-content-center">Edit Sci-fi</h1>
            <div className="new-container d-flex justify-content-center align-items-center">
            
         <div className="col-7">
            <form className="whole-form" action={`/scifis/${_id}?_method=PUT`} method="post">
            ...
            <div className="form-group"> 
              <label for="title" >Title</label> 
                ...
                <input className="btn btn-primary" type="submit" name="" value="Update Sci-fi"/>
                </div>
