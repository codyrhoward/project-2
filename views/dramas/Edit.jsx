...
class Edit extends React.Component {
    render() {
        const { _id, title, image, watched, trailer, synopsis} = this.props.drama;
        return (
            <Default>
            <br/>
            <h1 className="new-h1 d-flex justify-content-center">Edit Drama</h1>
         ...
         <div className="col-7">
            ...
            <div className="form-group"> 
              <label for="title" >Title</label> 
                ...
                <input className="btn btn-primary" type="submit" name="" value="Update Drama"/>
                </div>
